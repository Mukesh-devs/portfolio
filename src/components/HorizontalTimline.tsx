...
// --- Data ---
// (Experience and Certification data remains here)
...
const certificationData: TimelineItem[] = [
    { id: 'cert1', title: 'SQL Certification', organization: 'HackerRank', location: 'Online', period: 'Jan 2025', description: 'Demonstrated proficiency in SQL queries, database design, and data manipulation.', type: 'certification', skills: ['SQL', 'Database Design'], link: 'https://hackerrank.com' },
    { id: 'cert2', title: 'Docker Foundations Professional', organization: 'LinkedIn', location: 'Online', period: 'Jun 2024', description: 'Professional certification in Docker containerization and DevOps practices.', type: 'certification', skills: ['Docker', 'DevOps', 'Containerization'], link: 'https://linkedin.com' },
    { id: 'cert3', title: 'JavaScript Certification', organization: 'GUVI', location: 'Online', period: 'Aug 2023', description: 'Comprehensive JavaScript programming certification covering ES6+ features and modern development practices.', type: 'certification', skills: ['JavaScript', 'ES6+', 'Web Development'] },
    { id: 'cert4', title: 'Java Full-Stack', organization: 'Naresh I Technologies', location: 'Online', period: 'Mar 2023', description: 'Completed a comprehensive course on full-stack Java development, including advanced frameworks.', type: 'certification', skills: ['Java', 'Spring', 'Hibernate', 'React'] },
    { id: 'cert5', title: 'Python for Data Science', organization: 'Coursera', location: 'Online', period: 'Jan 2023', description: 'Specialized in Python programming for data analysis, manipulation, and visualization.', type: 'certification', skills: ['Python', 'Pandas', 'NumPy', 'Matplotlib'] },
    { id: 'cert6', title: 'AWS Certified Cloud Practitioner', organization: 'Amazon Web Services', location: 'Online', period: 'Nov 2022', description: 'Foundational certification demonstrating knowledge of the AWS Cloud and its core services.', type: 'certification', skills: ['AWS', 'Cloud Computing', 'IAM', 'S3'] },
];
...
const TimelineCard: React.FC<{ item: TimelineItem; isMobile?: boolean }> = ({ item, isMobile = false }) => {
  ...
  return (
    <div className={`${cardClasses} bg-white/90 dark:bg-slate-700/90 backdrop-blur-sm rounded-xl shadow-lg p-6 relative`}>
      <div className={`absolute -top-4 left-6 w-8 h-8 bg-gradient-to-r ${getTypeColor(item.type)} rounded-full flex items-center justify-center`}>
